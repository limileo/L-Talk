<?php get_header();?>
	...
	<div class="container">
		<div class="box_title matrix_title"><h2>{ <?php $thiscat = get_category($cat); echo $thiscat ->name;?>
		 }
		</h2>
		<span>文章 <?php global $wp_query; $cat_ID = get_query_var('cat'); echo get_category($cat_ID)->count;?> 篇</span>
		</div>
		<ul>
		<?php if( have_posts() ): ?>
